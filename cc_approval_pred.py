...
def make_prediction():
    ...
    client = boto3.client('s3', aws_access_key_id=st.secrets["SHA256:Bj/JCUKH18+LpBBcRo7i40N0LMgKczDCpGU50jUMmbs"],aws_secret_access_key=st.secrets["SHA256:Bj/JCUKH18+LpBBcRo7i40N0LMgKczDCpGU50jUMmbs"]) # for s3 API keys when deployed on streamlit share
